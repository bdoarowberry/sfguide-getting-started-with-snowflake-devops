    ...
    begin
      ...
      if (:options = '[]') then
        CALL SYSTEM$SEND_EMAIL(
            'email_integration',
            'arowberry@bdo.ca', -- INSERT YOUR EMAIL HERE
      ...
      let query varchar := 'Considering the data provided below in JSON format, pick the best city for a family vacation in winter?
      ...
      CALL SYSTEM$SEND_EMAIL(
        'email_integration',
        'arowberry@bdo.ca', -- INSERT YOUR EMAIL HERE
        'New data successfully processed: The perfect place for your winter vacation has been found.',
        :response);
    exception
